package com.psb.dorsa.irancell;
...
import static com.psb.dorsa.payment.IMPayment.SH_P_BUY_IN_APP;
import static com.psb.dorsa.payment.IMPayment.SH_P_BUY_IN_APP_ACCESS_TOKEN;
import static com.psb.dorsa.payment.IMPayment.SH_P_BUY_IN_APP_DATE;
import static com.psb.dorsa.payment.IMPayment.SH_P_BUY_IN_APP_HAS_KEY;
import static com.psb.dorsa.payment.IMPayment.SH_P_BUY_IN_APP_PHONE_NUMBER;
import static com.psb.dorsa.payment.IMPayment.SH_P_BUY_IN_APP_REGISTERED;
import static com.psb.dorsa.payment.PPayment.access_token;
...
public class IrancellCancel {
    ...
    public void cancelPurchase(String irancellSku) {
        ...
        Call<Object> call = service.cancel(context.getPackageName(),
                irancellSku,
                Utils.getStringPreference(context,Utils.PURCHASETOKEN, Utils.PURCHASETOKENKEY,""),access_token
        );
    ...
    public void clearUserInfo(){
        ...
        sharedPrefereceEditor.putBoolean(SH_P_BUY_IN_APP_HAS_KEY, false);
